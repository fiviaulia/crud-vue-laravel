              ...
              <tbody>
                <tr v-for="(siswa, index) in posts.data" :key="index">
                  ...
                  <!-- <td class="text-center">
                    <router-link :to="{name: 'siswa.update', params:{id:siswa.id }}" class="btn btn-sm btn-primary mr-1">Edit</router-link>
                    <button @click="confirmDelete(siswa.id)" class="btn btn-sm btn-danger ml-1">Delete</button>
                  </td> -->
                </tr>
              </tbody>
            </table>
